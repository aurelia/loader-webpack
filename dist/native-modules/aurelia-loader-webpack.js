...
*/
export var WebpackLoader = (function (_super) {
    ...
    WebpackLoader.prototype._import = function (moduleId) {
        return __awaiter(this, void 0, void 0, function () {
            var moduleIdParts, modulePath, loaderPlugin, plugin, callback_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        if (__webpack_require__.m[modulePath]) {
                            return [2 /*return*/, __webpack_require__(modulePath)];
                        }
                        if (!__webpack_require__.m["async!" + modulePath])
                            return [3 /*break*/, 4];
                        callback_1 = __webpack_require__("async!" + modulePath);
                        return [4 /*yield*/, new Promise(function (resolve) { return callback_1(resolve); })];
                    case 3: return [2 /*return*/, _a.sent()];
                    case 4: throw new Error("Unable to find module with ID: " + modulePath);
                }
            });
        });
    };
